 ...
 *
 * ************************************************************ */
u32	glcoex_ver_date_8192e_2ant = 20160818;
u32	glcoex_ver_8192e_2ant = 0x44;
u32	glcoex_ver_btdesired_8192e_2ant = 0x44;
	...
	case 7:
		if (coex_sta->scan_ap_num <= NOISY_AP_NUM_THRESH_8192E)
			halbtc8192e2ant_coex_table(btcoexist, force_exec,
				   0xffffffff, 0xfafafafa, 0xffffff, 0x3);
		else
			halbtc8192e2ant_coex_table(btcoexist, force_exec,
				   0xffffffff, 0x5a5a5a5a, 0xffffff, 0x3);
		break;
	case 8:
		halbtc8192e2ant_coex_table(btcoexist, force_exec, 0x5f5f5f5f,
					   0x5a5a5a5a, 0xffffff, 0x3);
		break;
	default:
		break;
		     ...
		     IN boolean force_exec, IN boolean turn_on, IN u8 type)
{
	...
	if (turn_on) {
		...
		case 1:
		default:	/*d1,wb*/
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x3c,
						      0x03, 0x11, 0x10);
			break;
		case 2:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x32,
						      0x03, 0x11, 0x10);
			break;
		case 3:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x28,
						      0x03, 0x11, 0x10);
			break;
		case 4:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x1e,
						      0x03, 0x11, 0x10);
			break;
		case 5:		/*d1,pb,TXpause*/
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x63, 0x3c,
						      0x03, 0x90, 0x10);
			break;
		case 6:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x63, 0x32,
						      0x03, 0x90, 0x10);
			break;
		case 7:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x63, 0x28,
						      0x03, 0x90, 0x10);
			break;
		case 8:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x63, 0x1e,
						      0x03, 0x90, 0x10);
			break;
		case 9:		/*d1,bb*/
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x3c,
		...
		case 20:
			...
			break;
		case 21:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x61, 0x35,
						      0x03, 0x11, 0x11);
			break;
		case 22:	/* d1,wb */
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x14,
						      0x03, 0x11, 0x14);
			break;
		case 23:	/* d1,pb,TXpause */
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x63, 0x14,
						      0x03, 0x90, 0x14);
			break;
		case 24:	/* d1,bb */
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0xe3, 0x14,
		...
		case 80:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51, 0x3c,
						      0x3, 0x10, 0x50);
			break;
		case 81:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51,
				0x3a + wifi_duration_adjust, 0x3, 0x10, 0x50);
			break;
		case 82:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51,
				0x30 + wifi_duration_adjust, 0x03, 0x10, 0x50);
			break;
		case 83:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51, 0x21,
						      0x03, 0x10, 0x50);
			break;
		case 84:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51, 0x15,
						      0x3, 0x10, 0x50);
			break;
		case 85:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51, 0x3a,
						      0x03, 0x10, 0x50);
			break;
		case 86:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51, 0x21,
			...
			break;
		case 87:
			halbtc8192e2ant_set_fw_pstdma(btcoexist, 0x51, 0x14,
						      0x03, 0x10, 0x54);
			break;
...
void halbtc8192e2ant_init_coex_dm(IN struct btc_coexist *btcoexist)
{
	...
	halbtc8192e2ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE, 0x0,
					 0x0);
	halbtc8192e2ant_ps_tdma(btcoexist, FORCE_EXEC, false, 0);
...
boolean halbtc8192e2ant_is_common_action(IN struct btc_coexist *btcoexist)
{
	...
	if (!wifi_connected) {
		...
		halbtc8192e2ant_power_save_state(btcoexist, BTC_PS_WIFI_NATIVE,
						 0x0, 0x0);
		...
		if (BT_8192E_2ANT_BT_STATUS_NON_CONNECTED_IDLE ==
			...
			halbtc8192e2ant_power_save_state(btcoexist,
...
void halbtc8192e2ant_action_sco_pan(IN struct btc_coexist *btcoexist)
{
	...
	if ((BTC_RSSI_HIGH(wifi_rssi_state) && (!BTC_RSSI_LOW(bt_rssi_state))))
		...
		halbtc8192e2ant_power_save_state(btcoexist, BTC_PS_LPS_ON, 0x50,
						 0x4);
...
void halbtc8192e2ant_action_a2dp(IN struct btc_coexist *btcoexist)
{
	...
	if (BTC_RSSI_HIGH(wifi_rssi_state) && (!BTC_RSSI_LOW(bt_rssi_state)) &&
		...
		halbtc8192e2ant_sw_mechanism2(btcoexist, false, false, false,
		 ...
		 (!BTC_RSSI_LOW(bt_rssi_state)) &&
		 (coex_sta->scan_ap_num > NOISY_AP_NUM_THRESH_8192E))
		halbtc8192e2ant_sw_mechanism2(btcoexist, false, false, true,
					      0x06);
	else
		halbtc8192e2ant_sw_mechanism2(btcoexist, false, false, false,
					      0x18);
