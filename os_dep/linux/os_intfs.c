...
struct dvobj_priv *devobj_init(void)
{
...
#ifdef CONFIG_SWTIMER_BASED_TXBCN
#if LINUX_VERSION_CODE < KERNEL_VERSION(4, 15, 0)
	_init_timer(&pdvobj->txbcn_timer, NULL, _tx_beacon_timer_handler,
		    pdvobj);
#else
	timer_sxetup(&pdvobj->txbcn_timer, _tx_beacon_timer_handler, 0);
#endif
#endif
#endif
	...
	_init_timer(&pdvobj->dynamic_chk_timer, NULL,
		    _dynamic_check_timer_handler, pdvobj);
#else
